defmodule JidoDemo1.LLM do
  @moduledoc """
  Model-client boundary. The concrete client is chosen by the `:llm_client`
  application setting: `JidoDemo1.LLM.OpenRouter` in normal use and
  `JidoDemo1.LLM.Stub` under test, so simulations can run deterministically.
  """
  ...
  @spec client() :: module()
  def client, do: Application.get_env(:jido_demo1, :llm_client, JidoDemo1.LLM.OpenRouter)
