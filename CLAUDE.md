# jido_demo1: The Etheridge Circle, 1891

Elixir/Jido multi-agent demo. Four agents, each a character in an 1891 epistolary drama, write letters via OpenRouter. See `README.md` for the run instructions and module map.
